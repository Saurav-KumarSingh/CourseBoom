    ...
    return (
        <div className="flex justify-center items-center h-screen">
            <div className="lg:p-10 md:p-40 sm:20 p-8 w-full lg:w-1/2">
                <h1 className="text-2xl font-semibold mb-4">Request New Course</h1>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        <label htmlFor="message" className="block">Course</label>
                        <textarea
                            id="message"
                            name="message"
                ...
                <div className="mt-4">
                        ...
                        <Link to="/courses" className="hover:underline text-blue-500"> Click</Link>
                    </div>
            </div>
        </div>
    );
